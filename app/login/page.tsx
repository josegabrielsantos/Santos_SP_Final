        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-3 mt-2">
            {[
              ...
              <li key={item} className="flex items-start gap-2.5 text-[15px] text-primary-foreground/85">
                <CheckCircle2 className="mt-0.5 h-4.5 w-4.5 shrink-0 text-primary-foreground/60" />
                {item}
              </li>
            ))}
          </ul>
            ...
            <Card className="w-full border-border/50 bg-white card-shadow-md rounded-2xl">
              <CardContent className="px-8 py-9 sm:px-10">
                ...
                <div className="flex flex-col items-center gap-5">
                  ...
                  {/* Text branding fallback / supplement */}
