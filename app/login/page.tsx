  ...
  const handleGoogleLogin = useGoogleLogin({
    ...
    onSuccess: async (tokenResponse) => {
      try {
        ...
        // The @react-oauth/google implicit flow returns an access_token.
        // We need to use the credential (id_token) flow instead.
        // Let's use the Google tokeninfo endpoint to get user details
        // Actually, we should use the one-tap / credential flow.
        // For now, we'll send the access_token and handle it on the backend.
      ...
      <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary to-primary/70 px-12 py-10 text-primary-foreground">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[18px] text-primary-foreground/80 leading-relaxed max-w-sm">
            ...
            curated research, community discussions, and more.
          </p>
        </div>
              ...
              <div className="flex flex-col items-center gap-5">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-[16px] text-muted-foreground">
                    Sign in to UPLB KAIN to continue
                  </p>
                </div>
              </div>
